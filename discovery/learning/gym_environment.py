...
class BaseGymEnvironment(gym.Env):
    ...
    def gather_data(self):
        ...
        # CPG data
        # p_gen = self.discovery.get_cartesian_state_generator()
    ...
    def plot(self):
        try:
            ...
            figure.add_subplot(FIG_COORDS[0], FIG_COORDS[1], index)
            plt.title('System discovery. and CPG in cart. coordinates')
            ...
            figure.add_subplot(FIG_COORDS[0], FIG_COORDS[1], index)
            plt.title('System discovery. and CPG in joint. coordinates')
